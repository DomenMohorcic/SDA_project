...
but latter are very close to passing the Shapiro test. We can also check if
...
follow a nice line, so our model is valid. The most concerning thing is the R^2
value, which is only `r summary(fit_wh)$r.squared`.
